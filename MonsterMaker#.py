...
Elements = ['Fire', 'Ice', 'Water', 'Thunder', 'Dragon', 'Fire/Ice' , 'Fire/Water', 'Fire/Thunder', 'Fire/Dragon', 'Ice/Water' , 'Ice/Thunder' , 'Ice/Dragon', 'Water/Thunder', 'Water/Dragon', 'Thunder/Dragon','None']
...
n=input('Enter the number of attempts you would like.')
if(n=='1'):
